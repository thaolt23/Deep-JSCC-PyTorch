...
class DeepJSCC(nn.Module):
    ...
    def loss(self, prd, gt):
        ...
        return loss
# =====================================================
# FIS-ENHANCED MODEL (KẾ THỪA – KHÔNG PHÁ BASELINE)
# =====================================================
# =====================================================
# FIS modules
# =====================================================
...
class DeepJSCC_FIS(DeepJSCC):
    """
    Encoder / Decoder / Channel giống 100% DeepJSCC
    Chỉ thêm FIS ở latent space
    """
    def __init__(self, c, channel_type='AWGN', snr=None):
        super().__init__(c, channel_type, snr)
    ...
    def forward(self, x, fis_snr=10.0, target_rate=0.5, return_info=False):
        ...
        bits = torch.clamp(bits, min=1.0, max=8.0)
